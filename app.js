...
form.addEventListener('submit',function(e){
	...
	if(isNaN(value))
	{
		result.innerHTML="Please Enter the number of paragraph you want..";
	}
	else if (value<=0)
	{
		result.innerHTML="Please Enter valid number of paragraph..";
	}
	else if (value>9)
	{
		result.innerHTML="Please Enter the number of paragraph between (0-9) because we have only 9 paragraph ..";
	}
	else
	{
